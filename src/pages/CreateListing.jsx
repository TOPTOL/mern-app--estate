    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            rounded-lg' id='name' maxLength='50' minLength='10' required/>
            <textarea type='text' placeholder='Description' className='border p-3
            rounded-lg' id='description' maxLength='50' minLength='10' required/>
            <input type='text' placeholder='Address' className='border p-3
            rounded-lg' id='address' maxLength='50' minLength='10' required/>
            ...
            <div className=' flex flex-wrap gap-6'>
                ...
                <div className='flex items-center gap-2'>
                    <input type='number' id='discounted price' min='1' max='10'
                     required className='p-3 border-gray-300 rounded-lg'/>
                     <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                rounded w-full' type='file' id='images' accept='images/*' multiple/>
                <button type='button' 
                disabled={uploading}
            ...
            <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
            {
                formData.imageUrls.length > 0 && formData.imageUrls.map(
                    (url, index) => (
                        ...
                        uppercase hover:opacity-70'>Delete</button>

                        </div>
                    ))
            }
            
            <button type='button'  className='p-3 bg-slate-700 text-white rounded-lg
