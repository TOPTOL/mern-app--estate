    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            rounded-lg' id='name' maxLenght='50' minLenght='10' required/>
            <textarea type='text' placeholder='Description' className='border p-3
            rounded-lg' id='description' maxLenght='50' minLenght='10' required/>
            <input type='text' placeholder='Address' className='border p-3
            rounded-lg' id='address' maxLenght='50' minLenght='10' required/>
